...
export default function ReviewsIndex() {
  ...
  return (
    <section className="shell py-20 sm:py-28">
      <h1 className="ags-enter mono text-3xl tracking-[0.02em] text-[var(--text)] uppercase sm:text-5xl">
        REVIEWS
      </h1>

      <p className="ags-enter mt-8 max-w-[60ch] text-[17px] leading-[1.75] text-[var(--muted)] [--ags-delay:90ms] sm:text-lg">
