...
export default function NotFound() {
  return (
    <section className="shell py-28 sm:py-40">
      <h1 className="mono max-w-[20ch] text-2xl leading-[1.2] tracking-[0.02em] text-[var(--warn)] uppercase sm:text-4xl">
      ...
      <Link
        href="/"
        className="mono mt-12 inline-block border border-[var(--acid)] px-6 py-3.5 text-[10px] tracking-[0.18em] text-[var(--acid)] uppercase transition-colors hover:bg-[var(--acid)] hover:text-[var(--bg)] sm:text-[11px]"
      >
